"""
Django settings for LocalBusinessNetwork project.
...
ROOT_URLCONF = 'LocalBusinessNetwork.urls'
...
WSGI_APPLICATION = 'LocalBusinessNetwork.wsgi.application'
...
AUTH_USER_MODEL = 'localBusinessNetwork.LbnxUser'
